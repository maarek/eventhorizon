...
func (t Command) AggregateID() eh.ID              { return t.ID }
...
func (t CommandOther) AggregateID() eh.ID              { return t.ID }
...
func (t CommandOther2) AggregateID() eh.ID              { return t.ID }
...
// EntityID implements the EntityID method of the eventhorizon.Entity interface.
func (m *SimpleModel) EntityID() eh.ID {
	return m.ID
}
...
func (m *AggregateStore) Load(ctx context.Context, aggregateType eh.AggregateType, id eh.ID) (eh.Aggregate, error) {
	if m.Err != nil {
		return nil, m.Err
	}
	m.Context = ctx
...
func (m *EventStore) Load(ctx context.Context, id eh.ID) ([]eh.Event, error) {
	if m.Err != nil {
		return nil, m.Err
	}
	m.Loaded = id
